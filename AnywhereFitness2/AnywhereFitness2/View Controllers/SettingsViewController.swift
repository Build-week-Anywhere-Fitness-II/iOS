...
//  AnywhereFitness2
//
//  Created by John McCants on 10/24/20.
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        isUserInteractionEnabled(bool: true)
            ...
            if let username = userNameTextField.text {
                FirebaseController.shared.updateUser(key: "username", value: username)
            }
            if let name = nameTextField.text {
                FirebaseController.shared.updateUser(key: "name", value: name)
            }
...
//            }
    ...
    func stackViewConfiguration() {
        // Adding The Fields and Labels to a Vertical StackView
          let stackView = UIStackView(arrangedSubviews: [userNameLabel, userNameTextField, nameTextLabel, nameTextField])
        ...
        logoutButton.topAnchor.constraint(equalTo: userNameTextField.bottomAnchor, constant: 20).isActive = true
